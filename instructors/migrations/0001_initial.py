    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['name'], name='instructors_name_312990_idx')],
            },
        ),
        migrations.CreateModel(
            name='InstructorRank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('License', 'License'), ('Certification', 'Certification'), ('Workshop', 'Workshop'), ('Seminar', 'Seminar'), ('Training', 'Training'), ('Short Course', 'Short Course')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('experienceType', models.CharField(choices=[('Academic Position', 'Academic Position'), ('Work Experience', 'Work Experience'), ('Research Role', 'Research Role'), ('Administrative Role', 'Administrative Role'), ('Extension Service', 'Extension Service'), ('Consultancy', 'Consultancy')], max_length=30)),
                ('isVerified', models.BooleanField(default=False)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preferences', to='core.instructor')),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scheduling.subject')),
            ],
            options={
